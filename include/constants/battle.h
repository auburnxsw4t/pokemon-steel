...
#define RIVAL_BATTLE_HEAL_AFTER    (1 << 0)
#define RIVAL_BATTLE_TUTORIAL_MODE (1 << 1)
#define RIVAL_BATTLE_TUTORIAL      (RIVAL_BATTLE_HEAL_AFTER | RIVAL_BATTLE_TUTORIAL_MODE)
